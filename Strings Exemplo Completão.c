/******************************************************************************
Strings Exemplo Completão
*******************************************************************************/
#include <stdio.h>   // Biblioteca para entrada e saída (printf, gets, etc.)
...
int main() {
    ...
    gets(string1);   // Leitura da primeira string (com espaços)

    printf("Digite a segunda string: ");
    gets(string2);   // Leitura da segunda string (com espaços)
